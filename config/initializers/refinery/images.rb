Refinery::Images.configure do |config|
  ...
  # config.user_image_sizes = {:medium=>"225x255>", :large=>"450x450>", :small=>"110x110>"}
  ...
  # config.dragonfly_secret = "ded7b075e82595ebe01203e6fd4863a2b27ab6ba844f8ef8"
  # If you decide to trust file extensions replace :ext below with :format
  # config.dragonfly_url_format = "/system/images/:job/:basename.:ext"
  # config.datastore_root_path = "/home/tj/Development/pizza-club/public/system/refinery/images"
